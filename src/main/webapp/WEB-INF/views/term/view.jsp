...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .title { font-size: 28px; font-weight: 700; color: #111; margin-bottom: 16px; }
        .definition { font-size: 18px; color: #374151; padding: 16px; background: #f9fafb; border-radius: 6px; margin-bottom: 16px; }
        .content { color: #374151; line-height: 1.6; white-space: pre-wrap; margin-bottom: 16px; }
        ...
        .btn { padding: 8px 16px; background: #6b7280; color: white; text-decoration: none; border-radius: 6px; border: none; cursor: pointer; }
...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="definition">${vo.definition}</div>
            ...
            <div class="meta">
                ...
                작성자: ${vo.authorName} | 작성일: ${vo.createDate} | 수정일: ${vo.updateDate}
            </div>
            <div class="actions">
